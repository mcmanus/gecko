                              ...
                              nsICancelable    **result)
{
  ...
  return AsyncResolveInternal(hostname, 0, flags,
...
ChildDNSService::AsyncResolveNative(const nsACString        &hostname,
                                    ...
                                    nsICancelable          **result)
{
  return AsyncResolveInternal(hostname, 0, flags, listener, target_,
...
ChildDNSService::CancelAsyncResolveNative(const nsACString       &aHostname,
                                          ...
                                          const OriginAttributes &aOriginAttributes)
{
  return CancelAsyncResolveInternal(aHostname, 0, aFlags, aListener,
