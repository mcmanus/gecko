...
#ifndef mozilla_net_SDTStream_h
#define mozilla_net_SDTStream_h
...
public:
  ...
  SDTStream(nsAHttpTransaction *, SDTSession *, int32_t);
...
//  Http2PushedStream *PushSource() { return mPushSource; }
  ...
  virtual SDTStream *GetConsumerStream() { return nullptr; };
  ...
  SDTSession *Session() { return mSession; }
...
protected:
  ...
  nsresult TransmitFrame();

private:
  friend class nsAutoPtr<SDTStream>;
  ...
  // in the SDTSession mStreamTransactionHash so it is important to
